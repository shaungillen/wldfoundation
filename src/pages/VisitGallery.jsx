...
export default function VisitGallery() {
  ...
  const handleArtworkClick = (artworkId) => {
    navigate(`/visit/gallery/${artworkId}`);
  };

  const handleCloseModal = () => {
    navigate('/visit/gallery');
  };
      ...
      <section className="py-16 md:py-24 bg-cream">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <Lead className="mb-8 max-w-2xl mx-auto">
            Explore the gallery from anywhere with our immersive room-by-room virtual tour, 
            complete with detailed artwork information.
          </Lead>
          <Button asChild className="bg-charcoal hover:bg-charcoal/90 text-cream">
