...
import { MapPin, Clock, Calendar, Phone, Mail, ArrowRight, Info } from 'lucide-react';

const visitOptions = [
  {
    icon: MapPin,
    title: 'Mount Kisco Gallery',
    description: 'Visit our private gallery space featuring rotating selections from the collection.',
    details: [
      'By appointment only',
      'Tuesday – Saturday',
      'Limited capacity for intimate viewing',
    ],
    cta: 'Schedule Visit',
    href: 'Tours',
  },
  {
    icon: Calendar,
    title: 'Guided Tours',
    description: 'Experience curated tours led by knowledgeable guides who provide context and insight.',
    details: [
      '90-minute guided experience',
      'Small group settings',
      'Specialized thematic tours available',
    ],
    cta: 'Request Tour',
    href: 'Tours',
  },
  {
    icon: Clock,
    title: 'Virtual Tours',
    description: 'Explore the collection remotely through our immersive 360° virtual gallery experience.',
    details: [
      'Available anytime',
      'Self-guided or scheduled',
      'Perfect for groups and educators',
    ],
