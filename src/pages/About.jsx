...
const providenceChips = [
  ...
  },
  {
    id: 'attention',
    label: 'Attention',
    content: 'True appreciation requires sustained looking. William spent time with works, returned to them, and understood that meaning deepens with repeated engagement. This patience informs how the Foundation presents the collection.',
  },
  {
    id: 'responsibility',
    label: 'Responsibility',
    content: 'Collectors bear responsibility to artists, to the public, and to future generations. William saw himself as a temporary caretaker of works that would outlive him—an ethic the Foundation maintains.',
  },
  {
    id: 'access',
    label: 'Access',
    content: 'Great art should not be hidden. From the beginning, William lent works to institutions and welcomed visitors. The Foundation continues this commitment through loans, tours, and digital initiatives.',
  },
  {
    id: 'care',
    label: 'Care',
    content: 'Stewardship means rigorous conservation, proper documentation, and thoughtful presentation. The Foundation maintains the highest standards to ensure these works endure for generations.',
  },
];
    ...
    <div className="min-h-screen bg-cream">
      ...
      >
            ...
            <div className="absolute inset-0 flex items-end">
              <div className="max-w-[1400px] mx-auto w-full px-4 md:px-6 lg:px-8 pb-12 md:pb-16">
                <div className="max-w-3xl">
                  ...
                  <p className="text-cream/80 text-lg mb-6 max-w-2xl">{slide.description}</p>
        ...
        <div className="absolute bottom-6 right-6 z-10 flex items-center gap-3">
          <button
            onClick={prevSlide}
            className="w-10 h-10 rounded-full bg-cream/20 backdrop-blur-sm border border-cream/30 flex items-center justify-center text-cream hover:bg-cream/30 transition-colors"
      ...
      {/* Mobile Index (under hero, scrollable pills) */}
      <div className="lg:hidden sticky top-20 z-40 bg-cream/95 backdrop-blur-sm border-b hairline py-3">
        <div className="px-4 flex gap-2 overflow-x-auto no-scrollbar">
          {navItems.map((item) => (
            <a
              ...
              href={`#${item.id}`}
              className={cn(
                "px-4 py-2 text-sm whitespace-nowrap rounded-full transition-colors border hairline",
                activeSection === item.id
                  ? 'bg-olive text-cream border-olive'
                  : 'bg-transparent text-charcoal/70 hover:text-charcoal border-charcoal/10'
              )}
            >
              {item.label}
            </a>
      ...
      <div className="relative">
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-[200px_1fr] lg:gap-12 xl:gap-16 py-8 lg:py-12">
              ...
              <nav className="sticky top-32 space-y-1">
                ...
                {navItems.map((item) => (
                  <a
                    ...
                    href={`#${item.id}`}
                    className={cn(
                      "flex items-center gap-3 py-2 text-sm transition-all group",
                      activeSection === item.id
                  ...
                  >
                    ...
                    <span className="relative">
                      {item.label}
                      {activeSection === item.id && (
                        <span className="absolute -left-3 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-olive" />
                      )}
                    </span>
                  </a>
                ))}
            ...
            <div className="space-y-16 md:space-y-24">
                ...
                <div className="max-w-3xl">
                  ...
                  <div className="space-y-4 mb-8">
                    <Body>
                      ...
                      this legacy through active stewardship—lending works to museums and institutions 
                      worldwide, supporting scholarship and education, and welcoming visitors.
                    </Body>
                    ...
                    {expandedPrinciple === 'mission' && (
                      <div className="space-y-4 border-t hairline pt-6">
                        ...
                        <ul className="space-y-2 pl-6">
                          <li className="text-charcoal/70"><strong>Stewardship:</strong> Rigorous conservation and documentation</li>
                          <li className="text-charcoal/70"><strong>Access:</strong> Active loan program and public engagement</li>
                          <li className="text-charcoal/70"><strong>Education:</strong> Research support and programming</li>
                        </ul>
                      </div>
                    )}
              ...
              <section id="principles" className="scroll-mt-32 border-t hairline pt-16 md:pt-24">
                <div className="mb-10">
                  <span className="text-xs uppercase tracking-[0.2em] text-olive mb-4 block">
                    Our Values
                  </span>
                ...
                <div className="grid md:grid-cols-3 gap-8 md:gap-0 md:divide-x hairline">
                  {/* Stewardship */}
                  <div className="md:pr-8">
                    ...
                    {expandedPrinciple === 'stewardship' && (
                      <Body className="text-sm mb-4 border-t hairline pt-4">
              ...
              {/* William Module */}
              <section id="william" className="scroll-mt-32 border-t hairline pt-16 md:pt-24">
                ...
                {/* Horizontal Scroll Carousel - Editorial Style */}
                <div className="relative">
                  <div 
                  ...
                  >
                    {williamChapters.map((chapter, index) => (
                      <button
                        ...
                        className="flex-shrink-0 w-[300px] snap-start text-left border-b hairline pb-6 hover:border-olive/50 transition-colors group"
                      >
              ...
              <section id="collection" className="scroll-mt-32 -mx-4 md:-mx-6 lg:-mx-8 px-4 md:px-6 lg:px-8 py-16 md:py-20 bg-charcoal text-cream">
                <div className="mb-10">
              ...
              {/* Programs */}
              <section id="programs" className="scroll-mt-32 border-t hairline pt-16 md:pt-24">
                ...
                <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-3 md:gap-12">
                  {programs.map((program, index) => (
                    <div key={index} className="border-t hairline pt-6 md:border-t-0 md:pt-0">
              ...
              <section id="providence" className="scroll-mt-32 border-t hairline pt-16 md:pt-24">
                <div className="max-w-3xl mx-auto">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          selectedProvidence === chip.id
                            ? 'bg-olive text-cream border-olive'
                            : 'bg-transparent text-charcoal/70 border-charcoal/20 hover:border-olive/30 hover:text-charcoal'
                        )}
                      >
                        {chip.label}
                      </button>
                  ...
                  {/* Content Panel - Simple with Hairlines */}
                  <div className="border-t border-b hairline py-8 min-h-[140px]">
                    {providenceChips.map((chip) => (
                      <div
                        key={chip.id}
                        className={cn(
                      ...
                      >
                        <Body className="text-center">{chip.content}</Body>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {/* Governance Preview */}
              <section id="governance" className="scroll-mt-32 border-t hairline pt-16 md:pt-24">
                <div className="mb-10">
                  <span className="text-xs uppercase tracking-[0.2em] text-olive mb-4 block">
                    Leadership
                  </span>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {boardMembers.map((member) => (
                        <div key={member.name} className="border-b hairline pb-4">
              ...
              <section id="community" className="scroll-mt-32 border-t hairline pt-16 md:pt-24">
              ...
              {/* Quote Section */}
              <section className="-mx-4 md:-mx-6 lg:-mx-8 px-4 md:px-6 lg:px-8 py-16 md:py-20 bg-charcoal text-cream">
