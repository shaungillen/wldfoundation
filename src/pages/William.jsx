...
import WilliamTimeline from '@/components/timeline/WilliamTimeline';
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-cream overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8">
          <span className="text-xs uppercase tracking-[0.2em] text-olive mb-4 block text-center md:text-left">
            Timeline
          </span>
          <H2 className="mb-16 text-center md:text-left">A Life in Milestones</H2>
